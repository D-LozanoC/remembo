...
export function Button({ children, variant = "primary", className = "", ...props }: ButtonProps) {
  const baseStyles =
    "w-full rounded-lg px-4 py-2 text-base font-semibold shadow-sm transition duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"

  const variantStyles = {
    primary: "bg-yellow_200 text-black hover:bg-yellow_500 focus-visible:outline-indigo-600",
